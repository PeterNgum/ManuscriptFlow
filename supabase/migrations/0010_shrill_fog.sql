/*
  # Review Decisions Schema Update

  1. Changes
    - Add decision_type field to review round decisions
    - Add status field to manuscript decision history
...
-- Update existing RLS policies with new conditions
